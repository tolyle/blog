  ...
  return (
    <div className={css.box} style={{ marginTop: '56px' }}>
      <Row className={css.web}>
        <Col span={12}>
          <div className={css.item}>
            ...
            <div className={css.content}>
              Bob Wang来自于中国的深圳，中文名为王东杰，具有15年后端程序开发和技术管理经验，热爱科技与视觉传达和令人兴奋的事情，总是以新鲜、创新和极简的方式追求理想的结果。
              <br />
              <br />
        ...
        <Col span={12} className={css.bImg}>
      ...
      <Row className={css.mobile}>
        ...
        <div>
          <div className={css.mobileTitle}> 关于我</div>
